    ...
    fProxyIpValid(true)
{
    ...
    ui->unit->setModel(new CoindevUnits(this));
...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->coindevAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Coindev."), QMessageBox::Ok);

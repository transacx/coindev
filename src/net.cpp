...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Coindev " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"coindevtools.com", "dnsseed.coindevtools.com"},
    {"coindevpool.org", "dnsseed.coindevpool.org"},
    {"xurious.com", "dnsseed.CDC.xurious.com"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"coindevtools.com", "testnet-seed.coindevtools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Coindev is probably already running."), addrBind.ToString().c_str());
        else

...
#ifndef H_COINDEV_SCRIPT
#define H_COINDEV_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCoindevAddress
 */
...
public:
    ...
    // Pre-version-0.6, Coindev always counted CHECKMULTISIGs

...
unlocked to sign the Coindev-Qt.app bundle.
...
allowing somebody to distribute a Coindev-Qt.app or coindev-qt-setup.exe with a valid
...
that the coindev-qt.exe file inside the installer had not been tampered with.
